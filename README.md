...
The first module `database_logic.js` which contains code to store and retrieve data from a database. <br>
A second module `date_formatting.js` which contains functions to convert date values from one format to another. <br>
